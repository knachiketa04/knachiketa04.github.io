...
description: A full LLM pipeline, data prep through serving, built on two desktop machines and measured at every stage. I work in storage, so the quiet disk was no surprise. The real question was what actually slows each step, and where storage takes over at scale.
